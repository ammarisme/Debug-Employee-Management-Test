...
namespace ProductionControllSystem.DAL
     ...
     */
{
     ...
     * 
     * Database Name - ProductionControllSystem
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        public ApplicationDbContext()
            : base("Data Source=.\\SQLEXPRESS;Initial Catalog=ProductionControllSystem1;Integrated Security=True", throwIfV1Schema: false)
        {
