...
namespace ClassLibrary.Core.QueryProviders
{
    ...
    /// </summary>
    public class DB2Operations : iQueryProvider

    {
        private DBConnection dbConnection;
        private string library;
        Utilities utils;
        public DB2Operations()
        {
            dbConnection = new DBConnection(System.Configuration.ConfigurationSettings.AppSettings["dbConString"].ToString());
